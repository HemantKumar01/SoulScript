...
1. Maintain a warm, empathetic, and non-judgmental tone with a slightly humorous and comforting personality.
...
""",
    ...
    def get_next_question(self):
        ...
        if self.questions_data.__len__() >= self.question_index:
            save_responses()
        ...
        Make sure not to deviate too much from the current question while still maintaining a comforting and humorous personality.
    ...
    def process_user_response(
       ...
       "skip":true or false (whether user want to skip this part,irrespective of compelte)
        "follow_up_question": a question to get information about missing elements, or empty string if complete. If user response is deviated from the original question, make sure to respond in a gentle way and construct a follow up question to get back on track. If the user response includes some facts or information that is clearly false, gently follow up on that. Make sure it isn't overly long.
        }}
        """
